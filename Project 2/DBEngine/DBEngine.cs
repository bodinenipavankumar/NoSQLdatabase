...
* -----------------
* public DBEngine()
* -- Constructor, initiaizes properties
*
* public bool insert(Key key, Value val)
* --inserts new Key/Value pair to database
*
* public bool delete(Key key)
* --Delete a Key/Value pair from database
*
* public bool edit_value(Value value, Key key)
* --Replaces existence value instance with given value Instance
*
* public int size()
...
* -- Returns key collection in database.
*
...
* --Displays database contents of collection type
*
*/
/*
 * Maintenance:
...
namespace Project2Starter
{
  public class DBEngine<Key, Value>
  {
    ...
    public int number_of_writes { get; set; } 
