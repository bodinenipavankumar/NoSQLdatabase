///////////////////////////////////////////////////////////////////////
// DBElement.cs - defines DBElement                                  //
// Ver 1.0                                                           //
 ...
 *
 *  DBElement type to be used by both:
 *
 ...
 * --------------------
 * ver 1.1 : 10 OCT 15
 * - changed test stub to test all functionalities
 * ver 1.0 : 13 Sep 15
 * - first release
 *
 */
  ...
  public static class LocalExtensions
  {
    ...
    public static string showElementWithTestType2<Key>(this DBElement<Key, List<string>> elem)
    {
      ...
      return accum.ToString();
        ...
        //public static string get_payload<Key>(this DBElement<Key, List<string>> elem)
        //{
        //    StringBuilder accum = new StringBuilder();
        //    //accum.Append(elem.showElemMetaData<Key, List<string>>());
        //    if (elem.payload != null)
